...
const RookIcon: React.FC<ChildIconProps> = ({ piece, isDragging, dragRef, ...props }) => {
  if (piece.color === 'black') return (
    <>
      <div style={{ width: '85%', height: '85%', ...props.style  }} ref={dragRef}>
      <svg width="100%" height="100%" viewBox="0 0 214 326" fill="none" xmlns="http://www.w3.org/2000/svg" cursor={isDragging ? 'grabbing' : 'grab'}>
